...
import video from "../Assects/Video.mp4"
import {
  onAuthStateChanged
} from "firebase/auth"
...
// export default React.memo(
  export default React.memo(function Card({ movieData, isLiked = false}) {
    const [isHovered, setIsHoverwd] = useState(false);
  ...
  return (
    <Container
      onMouseEnter={()=> setIsHoverwd(true)}
      onMouseLeave={()=> setIsHoverwd(false)}
    >  
                        ...
                        <div className="controls flex">
                            ...
                            <RiThumbDownFill title='Dislike'/>
                            {
                                isLiked ? (
                                    ...
                                    <AiOutlinePlus title='Addto my list' onClick={addToList} />
                                )
                            }
                        </div>
                        <div className="info">
